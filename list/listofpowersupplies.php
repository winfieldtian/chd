...
<p id = "greeter">Displaying power supplies in the database...</p>
...
{
	$query = "SELECT * FROM powersupply WHERE";
...
echo "<div id='contentBox' style='margin:0px auto; width:80%'>";
    ...
    $counter = 0;
	$result = searchbyAttribute("powersupply", $postCount, $postVals, $postKeys, $con);
	...
	$result = searchbyAttribute("memory", $postCount, $postVals, $postKeys, $con);
    $counter = 0;
