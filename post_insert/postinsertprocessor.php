...
insertElement("processor", $postCount, $postVals, $postKeys, $con);
...
<p id = "footer"><a href="processor.htm" style="color: #FFFFFF; text-decoration: none;">Back to processor search</a></p>
