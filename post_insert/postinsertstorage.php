...
insertElement("harddrive", $postCount, $postVals, $postKeys, $con);
...
<p id = "footer"><a href="storage.htm" style="color: #FFFFFF; text-decoration: none;">Back to storage search</a></p>
